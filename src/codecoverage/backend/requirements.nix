...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-epan8rls/src/codecoverage/backend/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -s intreehooks -s flit -s vcversioner -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "fakeredis" = python.mkDerivation {
      name = "fakeredis-1.0.1";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/b2/fd/8a9f3a76410224b9f39b1afffd84c999a72dfa2c671fd5ece479b83783fe/fakeredis-1.0.1.tar.gz";
        sha256 = "6da5424c96a40f652fad0b1c9f88c65c8629ac5a6abbcd0ee5089666ac73d176";
      };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";
